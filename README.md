#### 티타임과 사람 소개
안녕하세요🙋🏻‍♀️ 저는 let'Swift2019에서 <주니어 개발자의 성장하는 글쓰기> 티타임을 맡은 이규원이라고 합니다. 카카오페이지에서 어느덧 3년째 iOS를 개발하고 있는 주니어 개발자입니다.(저는 신문방송학에 발을 살짝 담그고, 작가를 꿈꾸었을 정도로 글쓰는 것을 좋아합니다🙃)
...
시작은 단순했습니다. 위 인용구처럼, 제 시간과 경험을 기록하려고 가능한 모든 것을 쓰기 시작했습니다. 제가 가장 정기적으로 쓰는 두가지 글은 1) 회사일지와 2) [팀내 블로그](https://github.com/Kyoo32/letSwift2019_growingWriting.wiki.git)&스펙문서 입니다.
